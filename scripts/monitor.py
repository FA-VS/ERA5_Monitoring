...
from modules.download_era5 import build_download_argparse, fetch_recent_year, DATA_DIR
...
def main(): #pylint: disable=missing-function-docstring
    ...
    # "Fetching" files
    ref = sorted(args.reference_list)
    ...
    recent = fetch_recent_year(args.recent_year,
                               ...
                               ) if args.fetch else sorted( recent_folder.glob("*.nc") ) # TODO: make the "else" traceable / reproducible
